...
import nyc.millman.salesforce.processor.SubscriberFactory;
...
public class SalesforceServiceApplication extends Application<SalesforceServiceConfiguration> {
    ...
    private final Logger logger = LoggerFactory.getLogger(SalesforceServiceApplication.class);
    ...
    public void run(SalesforceServiceConfiguration configuration, Environment environment) {
        ...
        SubscriberFactory subscriberFactory = new SubscriberFactory(configuration.getPubSubConfiguration(), configuration.getSubscriberConfiguration(), salesforceClient);
        subscriberFactory.registerResources();
